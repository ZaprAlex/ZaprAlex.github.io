...
extensionList = ['mp3']  # only these file types will be uploaded
...
def main(av):
    ...
    default_songs_path = os.path.join(os.getcwd(), 'public', 'mp3')
    destination_path = os.path.join(os.getcwd(), 'src/constants/music.json')
    if len(av) == 0:
